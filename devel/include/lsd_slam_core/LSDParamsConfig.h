...
namespace lsd_slam_core
{
  ...
  public:
    ...
    public:
      ...
      virtual void clamp(LSDParamsConfig &config, const LSDParamsConfig &max, const LSDParamsConfig &min) const override
      {
      ...
      virtual void calcLevel(uint32_t &comb_level, const LSDParamsConfig &config1, const LSDParamsConfig &config2) const override
      {
        if (config1.*field != config2.*field)
          comb_level |= level;
      }

      virtual void fromServer(const ros::NodeHandle &nh, LSDParamsConfig &config) const override
      {
        nh.getParam(name, config.*field);
      }

      virtual void toServer(const ros::NodeHandle &nh, const LSDParamsConfig &config) const override
      {
        nh.setParam(name, config.*field);
      }

      virtual bool fromMessage(const dynamic_reconfigure::Config &msg, LSDParamsConfig &config) const override
      {
        return dynamic_reconfigure::ConfigTools::getParameter(msg, name, config.*field);
      }

      virtual void toMessage(dynamic_reconfigure::Config &msg, const LSDParamsConfig &config) const override
      {
        dynamic_reconfigure::ConfigTools::appendParameter(msg, name, config.*field);
      }

      virtual void getValue(const LSDParamsConfig &config, boost::any &val) const override
      {
        val = config.*field;
      }
    };
    ...
    public:
      ...
      virtual void updateParams(boost::any &cfg, LSDParamsConfig &top) const override
      {
        PT* config = boost::any_cast<PT*>(cfg);
