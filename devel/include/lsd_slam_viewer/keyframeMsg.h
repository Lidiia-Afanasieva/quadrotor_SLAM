...
struct keyframeMsg_
{
  ...
  _width_type width;
   ...
   typedef std::vector<uint8_t, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<uint8_t>> _pointcloud_type;
...
bool operator==(const ::lsd_slam_viewer::keyframeMsg_<ContainerAllocator1> & lhs, const ::lsd_slam_viewer::keyframeMsg_<ContainerAllocator2> & rhs)
{
