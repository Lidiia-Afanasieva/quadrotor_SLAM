...
namespace lsd_slam_viewer
{
  ...
  public:
    ...
    public:
      ...
      virtual void clamp(LSDSLAMViewerParamsConfig &config, const LSDSLAMViewerParamsConfig &max, const LSDSLAMViewerParamsConfig &min) const override
      {
      ...
      virtual void calcLevel(uint32_t &comb_level, const LSDSLAMViewerParamsConfig &config1, const LSDSLAMViewerParamsConfig &config2) const override
      {
        if (config1.*field != config2.*field)
          comb_level |= level;
      }

      virtual void fromServer(const ros::NodeHandle &nh, LSDSLAMViewerParamsConfig &config) const override
      {
        nh.getParam(name, config.*field);
      }

      virtual void toServer(const ros::NodeHandle &nh, const LSDSLAMViewerParamsConfig &config) const override
      {
        nh.setParam(name, config.*field);
      }

      virtual bool fromMessage(const dynamic_reconfigure::Config &msg, LSDSLAMViewerParamsConfig &config) const override
      {
        return dynamic_reconfigure::ConfigTools::getParameter(msg, name, config.*field);
      }

      virtual void toMessage(dynamic_reconfigure::Config &msg, const LSDSLAMViewerParamsConfig &config) const override
      {
        dynamic_reconfigure::ConfigTools::appendParameter(msg, name, config.*field);
      }

      virtual void getValue(const LSDSLAMViewerParamsConfig &config, boost::any &val) const override
      {
        val = config.*field;
      }
    };
    ...
    public:
      ...
      virtual void updateParams(boost::any &cfg, LSDSLAMViewerParamsConfig &top) const override
      {
        PT* config = boost::any_cast<PT*>(cfg);
